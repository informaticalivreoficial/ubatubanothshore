...
$(document).ready(function () {
    var displaylimit = 3;
    var twitterprofile = "imoubaoficial";
	var screenname = "Imobiliária Ubatuba";
	...
	var headerHTML = '';
	var loadingHTML = '';
	//headerHTML += '<a href="https://twitter.com/" target="_blank"><img src="'+basesite+'/twitter-bird-light.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter" /></a>';
    ...
    $.getJSON('http://localhost/Imobiliaria-Ubatuba/app/twitterApi/twitterApi.php', 
        function(feeds) {   
		   //alert(feeds);
            var feedHTML = '';
